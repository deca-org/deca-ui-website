export declare const StyledCheckboxWrapper: import("@stitches/react/types/styled-component").StyledComponent<"div", {}, {
    n: string;
    xs: string;
    sm: string;
    md: string;
...
export declare const StyledCheckbox: import("@stitches/react/types/styled-component").StyledComponent<"input", {
