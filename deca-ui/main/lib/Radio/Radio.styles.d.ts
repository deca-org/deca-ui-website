export declare const StyledRadioWrapper: import("@stitches/react/types/styled-component").StyledComponent<"div", {}, {
    n: string;
    xs: string;
    sm: string;
    md: string;
...
export declare const StyledRadio: import("@stitches/react/types/styled-component").StyledComponent<"input", {
