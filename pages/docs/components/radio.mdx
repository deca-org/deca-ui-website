...
import { Radio } from "../../../deca-ui/module/index"
...
<ComponentWrapper>
  <Radio size="sm" initialSelect label="Small" />
  <Radio size="md" initialSelect label="Medium" />
  <Radio size="lg" initialSelect label="Large" />
</ComponentWrapper>
...
export default ({ children }) => <Layout mdx title="Radio">{children}</Layout>
