...
import { Box, Button, Modal, Input, Text } from "../../../deca-ui/module/index"
...
## Import
```
import { Modal } from "../../../deca-ui/module/index"
```
...
export default ({ children }) => <Layout mdx title="Modal">{children}</Layout>
