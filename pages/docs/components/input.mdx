...
import { DecaUIProvider, Input } from "../../../deca-ui/module/index"
...
## Import
```
import { Input } from "../../../deca-ui/module/index"
```
...
export default ({ children }) => <Layout mdx title="Input">{children}</Layout>
